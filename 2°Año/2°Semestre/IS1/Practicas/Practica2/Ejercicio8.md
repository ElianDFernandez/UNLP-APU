...
**Titulo:** 
Como vendedor (empleado del tratro)
Quiero poder ingresar los datos de la obra, junto con el nombre y DNI del espectador para reservar hasta 2 entradas de forma gratuita.
**Reglas de negocio:**
