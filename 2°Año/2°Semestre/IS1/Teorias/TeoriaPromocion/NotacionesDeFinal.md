...
- ***Basado en prototipos***
    ...
    * Prototipos descartables:
    ...
    ![alt text](img/ObjetivosModeloPrototipos.png)
...
![alt text](img/blog-scrum-process-opt.jpg)
