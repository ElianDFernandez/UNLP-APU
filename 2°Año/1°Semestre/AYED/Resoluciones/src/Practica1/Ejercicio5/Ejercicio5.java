...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        System.out.println(ClassEje5.maxminpromA(arreglo1).toString());
        ClassEje5.maxminpromB(arreglo2, d);
        System.out.println(d.toString());
        ClassEje5.maxminpromC(arreglo3);
        System.out.println(ClassEje5.obtenerResultados());
    }
}
