...
var 
    montoTotalDolares: real;
    valorDolar: real;
    comision: real;
begin 
    writeln('Ingrese el monto: ');
    read(montoTotalDolares);
    writeln('Valor de dolar hoy: ');
    read(valorDolar);
    writeln('Porcentaje de comision del banco: ');
    read(comision);
    comision := comision / 100;
    writeln('La transaccion sera de: ' , ((montoTotalDolares*valorDolar)-(montoTotalDolares*valorDolar)*comision):1:2);
end.